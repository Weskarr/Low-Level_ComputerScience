...
//from https://stackoverflow.com/a/78196937/306802

template<uint16_t Window>
class RollingAverageThree {
private:
    uint16_t m_index = 0;
    uint16_t m_count = 0;
...
public:
    uint32_t operator()(uint32_t input, const double factor = 1.0) {
...
private:
    RollingAverageThree<Window> m_rolling_average;
